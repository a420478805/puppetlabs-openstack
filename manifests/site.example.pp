...
$admin_email='sws@sina.com'
$password=$admin_password
$admin_tenant=$keystone_admin_tenant
$glance_user_password='123123'
$nova_user_password='123123'
...
node /keystone/{
  ...
  if ($enabled) {
    ...
    class { 'nova::keystone::auth':
      ...
      internal_address => $controller_host,
      admin_address    => $controller_host,
